...
let isColorFound; // here the declartion is showing the value as any since it's the initialization is done later

// the solution for this is found in anysolution.ts
...
let numberGreaterThanZero = false;
